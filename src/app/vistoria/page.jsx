...
<p className="text-center text-base"> A partir daqui, você será guiado(a) pela nossa interface personalizada durante as
<div className="form">
...
<input class="formulario" type="number" min="1" step=".1" name="txtValor" id="idValor" placeholder="Qual o v
</div>
<div class="form-texto">
...
<input class="formulario" type="date" name="txtDataCompra" id="idDataCompra" placeholder="Qual a data da com
</div>
